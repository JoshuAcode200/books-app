  ...
  return (
    <div className="bg-white p-8 md:p-6 rounded-lg shadow-md max-w-sm w-full box-border mx-auto">
      <div className="text-center mb-4">
        <h2 className='m-0 text-2xl text-gray-800 md:text-xl'>Login</h2>
      </div>
      <form className="flex flex-col">
        <label htmlFor="username" className='mb-2 text-gray-600'>Username</label>
        ...
        <button type="submit" href='http://localhost:3001/' className='p-3 bg-red-700 text-white md:text-sm border-none rounded-1 text-base cursor-pointer transition-colors duration-300 ease hover:bg-green-900'>Login</button>
      </form>
    </div>
  );
}
